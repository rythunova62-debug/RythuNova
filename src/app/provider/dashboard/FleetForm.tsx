  ...
  return (
    <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4 sm:grid-cols-2">
      ...
      <button
        type="submit"
        disabled={loading}
        className="col-span-2 mt-1 w-fit rounded-md bg-emerald-700 px-4 py-2 text-sm font-medium text-white transition hover:bg-emerald-800 disabled:opacity-50"
      >
        {loading ? "Saving..." : "Save"}
      </button>
    </form>
